...
class FifthGradeSumTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeSumTest2({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FifthGradeSumTest2State createState() => _FifthGradeSumTest2State();
}

class _FifthGradeSumTest2State extends State<FifthGradeSumTest2> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSumIntGenerator(5);
