...
class FifthGradeMultiplyTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeMultiplyTest2({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FifthGradeMultiplyTest2State createState() =>
      _FifthGradeMultiplyTest2State();
}

class _FifthGradeMultiplyTest2State extends State<FifthGradeMultiplyTest2> {
  late int _score;
  late int _wrong;
  List<int> question = RandomMultiplyIntGenerator(4);
  ...
  void nextQuestionCorrect(BuildContext context) {
    ...
    Future.delayed(Duration(seconds: 1), () {
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
              builder: (context) => FifthGradeMultiplyTest2(
                    score: _score,
                    wrong: _wrong,
                  )),
          (route) => false);
