...
class FifthGradeSubTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeSubTest({Key? key, this.score, this.wrong}) : super(key: key);

  @override
  _FifthGradeSubTest createState() => _FifthGradeSubTest();
}

class _FifthGradeSubTest extends State<FifthGradeSubTest> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSubIntGenerator(4);
