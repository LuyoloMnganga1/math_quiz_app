...
import 'fifth_grade.dart';

class FifthGradeScoreboard extends StatefulWidget {
  final int? score;
  final int? level;
  final String? method;
  const FifthGradeScoreboard(
      {Key? key, @required this.score, this.level, this.method})
      : super(key: key);
  @override
  _FifthGradeScoreboardState createState() => _FifthGradeScoreboardState();
}

class _FifthGradeScoreboardState extends State<FifthGradeScoreboard> {
