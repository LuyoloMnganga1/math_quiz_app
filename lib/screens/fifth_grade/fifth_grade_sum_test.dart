...
class FifthGradeSumTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeSumTest({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FifthGradeSumTestState createState() => _FifthGradeSumTestState();
}

class _FifthGradeSumTestState extends State<FifthGradeSumTest> {
  late int _score;
  late int _wrong;
