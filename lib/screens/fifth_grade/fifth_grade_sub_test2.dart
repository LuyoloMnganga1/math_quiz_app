...
class FifthGradeSubTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeSubTest2({Key? key, this.score, this.wrong})
      : super(key: key);

  @override
  _FifthGradeSubTest2 createState() => _FifthGradeSubTest2();
}

class _FifthGradeSubTest2 extends State<FifthGradeSubTest2> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSubIntGenerator(5);
