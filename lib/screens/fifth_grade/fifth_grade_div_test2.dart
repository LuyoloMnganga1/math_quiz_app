...
class FifthGradeDivTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeDivTest2({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FifthGradeDivTest2State createState() => _FifthGradeDivTest2State();
}

class _FifthGradeDivTest2State extends State<FifthGradeDivTest2> {
  late int _score;
  late int _wrong;
  List<int> question = RandomDivIntGenerator(6);
