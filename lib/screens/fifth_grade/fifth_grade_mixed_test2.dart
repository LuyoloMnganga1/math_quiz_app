...
class FifthGradeMixedTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeMixedTest2({Key? key, this.score, this.wrong})
      : super(key: key);

  @override
  _FifthGradeMixedTest2State createState() => _FifthGradeMixedTest2State();
}

class _FifthGradeMixedTest2State extends State<FifthGradeMixedTest2> {
  late int _score;
  late int _wrong;
