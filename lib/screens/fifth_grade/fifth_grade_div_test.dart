...
class FifthGradeDivTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FifthGradeDivTest({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FifthGradeDivTestState createState() => _FifthGradeDivTestState();
}

class _FifthGradeDivTestState extends State<FifthGradeDivTest> {
  late int _score;
  late int _wrong;
