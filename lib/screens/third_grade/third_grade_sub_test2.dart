...
class ThirdGradeSubTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const ThirdGradeSubTest2({Key? key, this.score, this.wrong})
      : super(key: key);

  @override
  _ThirdGradeSubTest2 createState() => _ThirdGradeSubTest2();
}

class _ThirdGradeSubTest2 extends State<ThirdGradeSubTest2> {
  late int _score;
  late int _wrong;
