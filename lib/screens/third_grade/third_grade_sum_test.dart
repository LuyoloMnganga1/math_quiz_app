...
class ThirdGradeSumTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const ThirdGradeSumTest({Key? key, @required this.score, this.wrong})
      : super(key: key);
...
class _ThirdGradeSumTestState extends State<ThirdGradeSumTest> {
  late int _score;
  late int _wrong;
