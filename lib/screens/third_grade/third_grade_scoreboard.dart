...
class ThirdGradeScoreboard extends StatefulWidget {
  final int? score;
  final int? level;
  final String? method;
  const ThirdGradeScoreboard(
      {Key? key, @required this.score, this.level, this.method})
      : super(key: key);
  @override
  _ThirdGradeScoreboardState createState() => _ThirdGradeScoreboardState();
}

class _ThirdGradeScoreboardState extends State<ThirdGradeScoreboard> {
