...
import 'package:math_quiz_app/screens/third_grade/third_grade_scoreboard.dart';

class ThirdGradeSumTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const ThirdGradeSumTest2({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _ThirdGradeSumTestState createState() => _ThirdGradeSumTestState();
}

class _ThirdGradeSumTestState extends State<ThirdGradeSumTest2> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSumIntGenerator(3);
  ...
  void navigateToScoreboard(BuildContext context) {
    Future.delayed(Duration(seconds: 1), () {
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ThirdGradeScoreboard(
                  score: _score,
                  level: 2,
                  method: Methods.sum,
                )),
