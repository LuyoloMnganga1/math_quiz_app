...
class ThirdGradeSubTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const ThirdGradeSubTest({Key? key, this.score, this.wrong}) : super(key: key);

  @override
  _ThirdGradeSubTest createState() => _ThirdGradeSubTest();
}

class _ThirdGradeSubTest extends State<ThirdGradeSubTest> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSubIntGenerator(2);
