...
class FourthGradeDivTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FourthGradeDivTest({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FourthGradeDivTestState createState() => _FourthGradeDivTestState();
}

class _FourthGradeDivTestState extends State<FourthGradeDivTest> {
  late int _score;
  late int _wrong;
  List<int> question = RandomDivIntGenerator(5);
  late int num1 = question[0];
  late int num2 = question[1];
  late var answers = RandomDivAnswerGenerator(num1, num2);
