...
class FourthGradeSumTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FourthGradeSumTest2({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FourthGradeSumTestState createState() => _FourthGradeSumTestState();
}

class _FourthGradeSumTestState extends State<FourthGradeSumTest2> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSumIntGenerator(4);
