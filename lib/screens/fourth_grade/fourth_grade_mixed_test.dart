...
class FourthGradeMixedTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FourthGradeMixedTest({Key? key, this.score, this.wrong})
      : super(key: key);

  @override
  _FourthGradeMixedTestState createState() => _FourthGradeMixedTestState();
}

class _FourthGradeMixedTestState extends State<FourthGradeMixedTest> {
  late int _score;
  late int _wrong;
  var question = MixedList(2);
