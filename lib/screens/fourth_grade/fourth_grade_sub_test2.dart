...
class FourthGradeSubTest2 extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FourthGradeSubTest2({Key? key, this.score, this.wrong})
      : super(key: key);

  @override
  _FourthGradeSubTest2 createState() => _FourthGradeSubTest2();
}

class _FourthGradeSubTest2 extends State<FourthGradeSubTest2> {
  late int _score;
  late int _wrong;
