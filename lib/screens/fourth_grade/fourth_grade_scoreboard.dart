...
class FourthGradeScoreboard extends StatefulWidget {
  final int? score;
  final int? level;
  final String? method;
  const FourthGradeScoreboard(
      {Key? key, @required this.score, this.level, this.method})
      : super(key: key);
  @override
  _FourthGradeScoreboardState createState() => _FourthGradeScoreboardState();
}

class _FourthGradeScoreboardState extends State<FourthGradeScoreboard> {
