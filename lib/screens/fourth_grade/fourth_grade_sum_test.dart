...
class FourthGradeSumTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FourthGradeSumTest({Key? key, @required this.score, this.wrong})
      : super(key: key);
...
class _FourthGradeSumTestState extends State<FourthGradeSumTest> {
  late int _score;
  late int _wrong;
