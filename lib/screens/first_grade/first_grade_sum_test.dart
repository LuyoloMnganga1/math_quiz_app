...
class FirstGradeSumTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const FirstGradeSumTest({Key? key, @required this.score, this.wrong})
      : super(key: key);

  @override
  _FirstGradeSumTestState createState() => _FirstGradeSumTestState();
}

class _FirstGradeSumTestState extends State<FirstGradeSumTest> {
  late int _score;
  late int _wrong;
