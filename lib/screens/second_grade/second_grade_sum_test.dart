...
class SecondGradeSumTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const SecondGradeSumTest({Key? key, @required this.score, this.wrong})
      : super(key: key);
...
class _SecondGradeSumTestState extends State<SecondGradeSumTest> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSumIntGenerator(1);
