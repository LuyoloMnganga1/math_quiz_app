...
class SecondGradeSubTest extends StatefulWidget {
  final int? score;
  final int? wrong;
  const SecondGradeSubTest({Key? key, this.score, this.wrong})
      : super(key: key);

  @override
  _SecondGradeSubTestState createState() => _SecondGradeSubTestState();
}

class _SecondGradeSubTestState extends State<SecondGradeSubTest> {
  late int _score;
  late int _wrong;
  List<int> question = RandomSubIntGenerator(1);
