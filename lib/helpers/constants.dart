...
import 'package:math_quiz_app/helpers/multiply_helper.dart';
import 'package:math_quiz_app/helpers/sub_helper.dart';
import 'package:math_quiz_app/helpers/sum_helper.dart';
...
RandomAlgGenerator(int gradeLevel){
  List<int> Numbers = [];
...
RandomSumAnswerGeneratorX(int a, int b) {
  List Answers = [];
  Answers.add(firstGradeHelperX(a, b));
  Answers.add(firstGradeARandomHelperX(a, b));
  Answers.add(firstGradeBRandomHelperX(a, b));
  Answers.add(firstGradeCRandomHelperX(a, b));
